...
@implementation WHTabScrollView
...
- (instancetype)initWithFrame:(CGRect)frame tabViews:(NSArray *)tabViews tabBarHeight:(CGFloat)height tabColor:(UIColor *)color backgroundColor:(UIColor *)backgroundColor {
  ...
  if (self) {
    ...
    [self addSubview:contentView];
      [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-0-[C(height)]|" options:0 metrics:@{@"height":@(height)} views:@{@"C":contentView}]];
      [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-0-[C]-0-|" options:0 metrics:nil views:@{@"C":contentView}]];
