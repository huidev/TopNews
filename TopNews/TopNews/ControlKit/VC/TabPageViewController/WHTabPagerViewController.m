...
#import "WHTabPagerViewController.h"
#import "WHTabScrollView.h"

@interface WHTabPagerViewController () <WHTabScrollDelegate, UIPageViewControllerDataSource, UIPageViewControllerDelegate>

@property (strong, nonatomic) UIPageViewController *pageViewController;
@property (strong, nonatomic) WHTabScrollView *header;
...
@implementation WHTabPagerViewController
...
- (void)reloadTabs {
  ...
  frame.origin.y = 64;
    ...
    if ([[self dataSource]respondsToSelector:@selector(tabFrame)]) {
        frame = [self.dataSource tabFrame];
    }
  
  [self setHeader:[[WHTabScrollView alloc] initWithFrame:frame tabViews:tabViews tabBarHeight:[self headerHeight] tabColor:[self headerColor] backgroundColor:[self tabBackgroundColor] selectedTabIndex:self.selectedIndex]];
