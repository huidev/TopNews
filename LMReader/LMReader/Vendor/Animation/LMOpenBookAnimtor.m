...
- (void)animateTransitionEvent {
    ...
    if (self.transitiontype==ControllerTransitionTypePresent) {
        ...
        RESideMenu *from =(RESideMenu*)self.fromViewController;
        UITabBarController *tabbarVC = (UITabBarController*)from.contentViewController;
        ...
        transformblank = CATransform3DMakeRotation(-M_PI_2 / 1.0, 0.0, 1.0, 0.0);
    ...
    {
        RESideMenu *from =(RESideMenu*)self.toViewController;
        UITabBarController *tabbarVC = (UITabBarController*)from.contentViewController;
        UINavigationController* nav = tabbarVC.viewControllers[0];
        shelfVC = (LMBookShelfVC*)nav.viewControllers[0];
